...
public class SentenceStore<K, V extends IGroupedSentence> {     //1. V是IGroupedSentence的子类

	private HashMap<K, V> storedSentences = new HashMap<K, V>();    //3. 里边有个Map
	
	public SentenceStore() {
	}
	
	public List<V> getExpiredItems(Date checkTime, int milliSeconds) {      //2. 返回V的集合
